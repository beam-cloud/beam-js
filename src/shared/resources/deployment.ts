...
import { DeploymentData } from "../../shared/types/deployment";
import APIResource from "./base";
import { EStubType } from "../../shared/types/stub";
import { beamOpts } from "../../shared/client";

// Avoid DOM lib requirement in dts build
...
export class Deployment {
  ...
  public async realtime(
    ...
    const ws: any = new WebSocket(this.websocketUrl(path));
