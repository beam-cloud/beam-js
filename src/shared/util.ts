...
import type { GpuTypeAlias } from "../shared/types/common";
...
// Node-only helper placeholder: in browser build, uploadToPresignedUrl will be stubbed
export const uploadToPresignedUrl = async (
  presignedUrl: string,
  filePath: string
): Promise<boolean> => {
  // This function is overridden in Node build
  throw new Error("uploadToPresignedUrl is Node-only");
};
